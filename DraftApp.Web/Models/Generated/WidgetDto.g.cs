...
{
    public partial class WidgetDtoGen : GeneratedDto<DraftApp.Data.Models.Widget>
    {
        public WidgetDtoGen() { }

        private int? _WidgetId;
        private string _Name;
        private DraftApp.Data.Models.WidgetCategory? _Category;
        ...
        public DraftApp.Data.Models.WidgetCategory? Category
        {
            get => _Category;
        ...
        /// </summary>
        public override void MapFrom(DraftApp.Data.Models.Widget obj, IMappingContext context, IncludeTree tree = null)
        {
            if (obj == null) return;
        ...
        /// </summary>
        public override void MapTo(DraftApp.Data.Models.Widget entity, IMappingContext context)
        {
            var includes = context.Includes;
        ...
        /// </summary>
        public override DraftApp.Data.Models.Widget MapToNew(IMappingContext context)
        {
            var includes = context.Includes;

            var entity = new DraftApp.Data.Models.Widget()
            {
                Name = Name,
